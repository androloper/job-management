...
import {Vbasr} from "../../../../../reports/summary-reports/vehiclebased-activity-summary-reports/models/vbasr";

@Component({
    selector: 'vbasr',
    templateUrl: './vbasr.component.html',
    styleUrls: ['../../../../../reports/activity-reports/activity-reports.component.scss']
})
export class VbasrComponent implements OnInit {
    ...
    constructor(private httpService: HttpClient,
                ...
                private paginationResponse: PaginationResponse<Vbasr>) {
        ...
        this.httpService.get(`${this.apiUrl}/GetListPaginationByVehicleId?VehicleId=${this.vehicleId}&PageNumber=${this.page.pageNumber}&PageSize=${this.page.size}`)
            .subscribe((data: PaginationResponse<any>) => {
                ...
                setTimeout(async () => {
                    ...
                    $('#ngx-dt48.datatable-scroll').width('100%');
                }, 2000);
